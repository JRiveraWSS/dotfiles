...
-- Switch to absolute numbers in insert mode, back to relative in normal mode
Config.new_autocmd('InsertEnter', nil, function() vim.o.relativenumber = false end, 'Absolute numbers in insert')
Config.new_autocmd('InsertLeave', nil, function() vim.o.relativenumber = true end,  'Relative numbers in normal')
