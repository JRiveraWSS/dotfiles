...
now(function() vim.cmd('colorscheme solarizeddark') end)
...
if not vim.g.vscode then now(function() require('mini.notify').setup() end) end
...
if not vim.g.vscode then now(function() require('mini.sessions').setup() end) end
...
if not vim.g.vscode then now(function() require('mini.starter').setup() end) end
...
if not vim.g.vscode then now(function() require('mini.statusline').setup() end) end

-- Tabline. Sets `:h 'tabline'` to show all listed buffers in a line at the top.
-- Buffers are ordered as they were created. Navigate with `[b` and `]b`.
-- TODO: Modify mapping for buffer navigation
if not vim.g.vscode then now(function() require('mini.tabline').setup() end) end
...
if not vim.g.vscode then later(function() require('mini.cmdline').setup() end) end
...
if not vim.g.vscode then later(function() require('mini.diff').setup() end) end
...
if not vim.g.vscode then later(function() require('mini.git').setup() end) end
...
if not vim.g.vscode then later(function() require('mini.pick').setup() end) end
